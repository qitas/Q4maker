...
#define BOARD_GEN7_CUSTOM       10   // Gen7 custom (Alfons3 Version) 
...
#define BOARD_Painter           555  // RAMPS 1.4 For Painter (Power outputs: Hotend0, Hotend1, Hotend2, Hotend3, Bed, Fan0, Fan1)
